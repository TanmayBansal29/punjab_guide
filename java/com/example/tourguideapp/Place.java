...
//    private String placeUrl;
    ...
    public Place(String name,String description, String location, String visitingTime, int imageResourceId){
        placeName = name;
...
//        placeUrl = url;
    ...
    public Place(String name, String location, String visitingTime, int imageResourceId){
        placeName = name;
        placeLocation = location;
        placeVisitingTime = visitingTime;
        placeImageResourceId = imageResourceId;
